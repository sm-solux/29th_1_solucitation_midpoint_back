...
public class EmailController {
    ...
    public ResponseEntity<?> sendVerificationEmailV2(@RequestBody @Valid VerificationEmailRequestDto verificationEmailRequestDto) {
    ...
    public ResponseEntity<?> verifyCodeV2(@RequestBody @Valid VerificationCodeRequestDto verificationCodeRequestDto) {
